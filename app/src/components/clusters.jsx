...
import { faucetTestTokens, getClusters, issueCluster, createTokenAccounts, redeemCluster, executeFlash } from "./funcs";
...
{loading ? "Loading.." : "TokenAccounts"}
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 14.25l6-6m4.5-3.493V21.75l-3.75-1.5-3.75 1.5-3.75-1.5-3.75 1.5V4.757c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0111.186 0c1.1.128 1.907 1.077 1.907 2.185zM9.75 9h.008v.008H9.75V9zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm4.125 4.5h.008v.008h-.008V13.5zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
   ...
   <div className="">
            ...
            <p id="helper-text-explanation" className="mb-4 text-sm flex justify-center align-middle text-gray-500 dark:text-gray-400">Make sure the token amounts include decimal zeroes in the amount.</p>
            <div className="">
            ...
            <h3 className="my-4 text-lg flex justify-center align-middle font-semibold text-gray-700 md:text-xl lg:text-xl">{}</h3>
            <span className="mb-4 text-sm flex justify-center align-middle text-gray-500 dark:text-gray-400">The entry-point of the flash loan contract should be named - "on_flash"</span>
            <div className="flex justify-center align-middle">
              
            <button className="mb-5 inline-flex text-white bg-cex border-0 py-2 px-6 focus:outline-none hover:bg-rex rounded text-lg" onClick={onFlash}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="mt-0.5 mr-0.5 w-6 h-6">
...
{loading ? "Loading.." : "Execute"}</button> <br /> <br />
            </div>
            </div>
            </div>
